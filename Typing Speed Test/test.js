...
/* Start test function resets values to start the test and then displays the first quote.
It also updates timer every second */
...
/* Check input function enters each character entered by user as an array element. 
It then splits the quote into characters and compares the two arrays.
In case of error the particular character turns red and the error count increases.
If correct the character turns green.
When length of both arrays is equal change quote function will be called to display the next quote.*/
